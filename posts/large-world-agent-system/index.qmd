...
![Agent System 的核心模块结构图：API、历史、注意力、资源、tick 与 agent loop](figures/system-map.png)
...
![中央注意力与分布式注意力的结构图](figures/attention-map.png)
...
![Agent 生命周期结构图：生成、运行、反馈、减速、压缩、收回](figures/lifecycle-map.png)
...
![Diagram of an agent system: API, history, attention, resources, tick, and agent loop.](figures/system-map.png)
...
![Diagram comparing central attention and distributed attention.](figures/attention-map.png)
...
![Agent lifecycle diagram: creation, running, feedback, slowing, compression, and reclaiming.](figures/lifecycle-map.png)
